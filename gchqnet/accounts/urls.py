...
urlpatterns = [
    ...
    path("login/badge/step-1/", views.BadgeLoginUsernamePromptView.as_view(), name="login_badge_username"),
    path("login/badge/step-2/", views.BadgeLoginChallengePromptView.as_view(), name="login_badge_challenge"),
